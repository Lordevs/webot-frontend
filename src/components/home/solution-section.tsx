              ...
              <CardContent className="relative p-8 lg:p-14">
                ...
                <div className="flex flex-col items-center justify-center gap-16 relative">
                  ...
                  <div className="relative w-48 h-48 flex items-center justify-center">
                    ...
                    {/* Data Flow Nodes */}
                    <PlatformNode
                      className="-top-8 -left-8 bg-primary/10 text-primary border border-primary/20 shadow-xl shadow-primary/5 backdrop-blur-md"
                      icon={<WhatsAppIcon className="w-6 h-6" />}
                      delay={0}
                    />
                    <PlatformNode
                      className="-bottom-8 -right-8 bg-primary/10 text-primary border border-primary/20 shadow-xl shadow-primary/5 backdrop-blur-md"
                    ...
                    {/* Flow Labels */}
                    <FloatingSnippet
                      className="-top-15 -left-12 bg-white/40 border-primary/20 backdrop-blur-md"
                      text="WhatsApp"
                      delay={0.2}
                    />
                    <FloatingSnippet
                    ...
                    />
                    <FloatingSnippet
                      className="-bottom-12 -right-12 bg-white/40 border-primary/20 backdrop-blur-md"
