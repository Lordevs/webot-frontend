    ...
    <div className="h-full relative p-1 bg-linear-to-br from-primary via-indigo-500 to-purple-600 rounded-[3rem] shadow-3xl shadow-primary/10">
      <div className="bg-background dark:bg-zinc-950 h-full rounded-[2.8rem] p-8 flex flex-col relative overflow-hidden group">
        ...
        <div className="flex items-center justify-between mb-6">
          <Badge className="bg-primary/10 text-primary border-none font-semibold text-[10px] uppercase px-3 py-1 tracking-widest">
            Next Appointment
          </Badge>
        ...
        <div className="flex-1 space-y-5">
          <div>
            <h3 className="text-2xl font-bold tracking-tight mb-2 line-clamp-1">
              {appointment.title}
            </h3>
        ...
        <div className="mt-8 pt-6 border-t border-border/10">
          <Button className="w-full h-12 rounded-xl font-semibold uppercase tracking-wider shadow-lg shadow-primary/10 flex items-center gap-2 group">
